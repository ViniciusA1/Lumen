...
enum class MouseCode
{
    ...
    ButtonMiddle = 2,  // Mouse button middle (pressed wheel)
    ButtonSide = 3,    // Mouse button side (advanced mouse device)
    ButtonExtra = 4,   // Mouse button extra (advanced mouse device)
    ButtonForward = 5, // Mouse button forward (advanced mouse device)
    ButtonBack = 6     // Mouse button back (advanced mouse device)
};
